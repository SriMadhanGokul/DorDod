...
const Avatar = ({
  ...
  avatar ? (
    ...
    <div
      className={`${size} rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold shrink-0 text-sm`}
    >
...
export default function NetworkPage() {
  ...
  const [mediaType, setMediaType] = useState<"image" | "video" | "pdf" | null>(
    null,
  );
  ...
  const clearMedia = () => {
    ...
    setLinkUrl("");
    setShowLink(false);
    [imageRef, videoRef, pdfRef].forEach((r) => {
  ...
  const doEditPost = async () => {
    ...
    try {
      ...
      setPosts((p) =>
        p.map((post) =>
          post._id === editPostData._id ? { ...post, ...res.data.data } : post,
        ),
      );
  ...
  return (
    <div
      className="space-y-5 animate-fade-in max-w-6xl mx-auto"
    ...
    >
      ...
      {posts.map((post) => (
        ...
        >
              ...
              <div className="relative" onClick={(e) => e.stopPropagation()}>
                ...
                {openMenu === post._id && (
                  <div className="absolute right-0 top-9 bg-white border border-gray-100 rounded-xl shadow-xl z-30 w-36 overflow-hidden">
                    ...
                    >
                      <FaEdit className="w-3.5 h-3.5 text-indigo-500" /> Edit
                      Post
                    </button>
                    <button
                      onClick={() => {
          ...
          {post.content && (
            <p className="text-sm leading-relaxed text-gray-800 whitespace-pre-wrap mb-1">
              {post.content}
            </p>
          )}
          ...
          <div className="flex items-center gap-4 mt-4 pt-3 border-t border-gray-100">
            ...
            >
              <FaComment className="w-4 h-4" /> {post.comments?.length || 0}{" "}
              Comments
            </button>
          </div>
            ...
            <div className="mt-3 border-t border-gray-100 pt-3 space-y-2">
                      ...
                      <>
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex items-center gap-1 shrink-0">
                            {c.isOwner && (
                              <button
                                onClick={() => startEditComment(post._id, c)}
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  disabled={
                    submitting === post._id || !commentTexts[post._id]?.trim()
                  }
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-lg my-auto shadow-2xl">
            ...
            {mediaFile && mediaType === "image" && mediaPreview && (
              <div className="relative mb-3">
                ...
                <button
                  onClick={clearMedia}
                  className="absolute top-2 right-2 w-7 h-7 bg-black/60 text-white rounded-full flex items-center justify-center hover:bg-red-500"
                >
              ...
              <div className="flex items-center gap-3 p-3 bg-red-50 border-2 border-red-100 rounded-xl mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400">
                    {(mediaFile.size / 1024 / 1024).toFixed(1)} MB • PDF
                  </p>
                </div>
                <button
                  onClick={clearMedia}
