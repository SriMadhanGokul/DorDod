    ...
    <div className="max-w-6xl mx-auto space-y-5 animate-fade-in">
      ...
      <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-xl border border-border">
        ...
        <p className="text-sm text-foreground-muted">
          <strong className="text-foreground">Guidance is optional.</strong> The
          system works fully without it. Use it when you want to explore a
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-foreground-muted">
              <div className="flex items-start gap-3">
                ...
                <p>
                  ...
                  Guidance asks questions — you provide the answers. You already
              ...
              <div className="flex items-start gap-3">
                ...
                <p>
                  ...
                  After the session, your Intent, Behavior, and Insights will be
                  updated — so the conversation becomes action.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="card-elevated text-center p-4">
              ...
              <p className="text-xs text-foreground-muted mt-1">
                Asks powerful questions. Reflects patterns. Never tells you what
                to do.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          {session.completed && (
            <div className="card-elevated border-success/30 bg-success/5 text-center py-4">
              <p className="text-success font-semibold">✅ Session completed</p>
