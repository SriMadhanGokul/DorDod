      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/setup-password"  element={<Protected><SetupPasswordPage /></Protected>} />
            ...
            <Route path="/development-plan" element={<Protected><DevPlanPage /></Protected>} />
            ...
            <Route path="/community"          element={<Protected><NetworkPage /></Protected>} />
            <Route path="/network"            element={<Protected><NetworkPage /></Protected>} />
            <Route path="/profile"          element={<Protected><ProfilePage /></Protected>} />
            <Route path="/scorecard"        element={<Protected><ScoreCardPage /></Protected>} />
            ...
            <Route path="/documents"          element={<Protected><ResourcesPage /></Protected>} />
            <Route path="/resources"          element={<Protected><ResourcesPage /></Protected>} />
            <Route path="/frame-of-mind"    element={<Protected><FrameOfMindPage /></Protected>} />

            {/* ─── Admin Routes ───────────────────────────────────────────── */}
            <Route path="/admin"                element={<AdminRoute><AdminDashboard /></AdminRoute>} />
            <Route path="/admin/users"          element={<AdminRoute><UsersPage /></AdminRoute>} />
            <Route path="/admin/users/:id"      element={<AdminRoute><UserDetailsPage /></AdminRoute>} />
            <Route path="/admin/goals"          element={<AdminRoute><GoalsManagement /></AdminRoute>} />
            <Route path="/admin/habits"         element={<AdminRoute><HabitsManagement /></AdminRoute>} />
            <Route path="/admin/courses"        element={<AdminRoute><CoursesManagement /></AdminRoute>} />
            <Route path="/admin/community"      element={<AdminRoute><CommunityModeration /></AdminRoute>} />
            <Route path="/admin/achievements"   element={<AdminRoute><AchievementsManagement /></AdminRoute>} />
            <Route path="/admin/notifications"  element={<AdminRoute><NotificationsPage /></AdminRoute>} />
            <Route path="/admin/settings"       element={<AdminRoute><SettingsPage /></AdminRoute>} />

            {/* ─── 404 ────────────────────────────────────────────────────── */}
            <Route path="/guidance"       element={<Protected><GuidancePage /></Protected>} />
            <Route path="/onboarding"     element={<Protected><OnboardingPage /></Protected>} />
            <Route path="/leaderboard"    element={<Protected><LeaderboardPage /></Protected>} />
            <Route path="/xp-history"     element={<Protected><XPHistoryPage /></Protected>} />
