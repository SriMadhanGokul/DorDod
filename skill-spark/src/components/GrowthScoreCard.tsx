...
export default function GrowthScoreCard({
  ...
  const chartData = [
    { name: "Score", value: score, fill: "#a855f7" },
    { name: "Remaining", value: 100 - score, fill: "#e9d5ff" },
  ];
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm h-full flex flex-col">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div className="text-center py-2.5 px-3 rounded-lg bg-purple-50 dark:bg-purple-900/20">
